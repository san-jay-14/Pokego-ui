...
/**
 * Bottom tray that surfaces the current compare selection and sends the two
 * chosen Pokémon into the Battlefield page. Hidden while already on the
 * Battlefield, where the selection is shown in full.
 */
export function CompareTray() {
  ...
  if (compare.length === 0 || location.pathname === '/battlefield') return null
    ...
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-40 flex justify-center px-4 pb-4">
      <div className="animate-float-in pointer-events-auto flex w-full max-w-xl items-center gap-3 rounded-2xl border border-border bg-surface/90 p-2.5 pl-3 shadow-[var(--shadow-lg)] backdrop-blur-xl">
        ...
        <div className="ml-auto flex items-center gap-2">
          <Button variant="primary" size="sm" onClick={() => navigate('/battlefield')}>
